...
export default function AdminProfile() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      ...
      <form onSubmit={onPasswordChange} className="space-y-4 rounded-2xl border border-line bg-surface-50 p-6 shadow-card">
        <h2 className="flex items-center gap-2 font-display font-bold text-text"><Lock className="h-4.5 w-4.5 text-secondary" /> {lang === "ar" ? "الأمان" : "Security"}</h2>
